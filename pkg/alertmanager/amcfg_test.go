...
func TestLoadConfig(t *testing.T) {
	testCase := []struct {
		...
		},
		{
			...
			golden: "RocketChat_apiUrl_field.golden",
		},
		{
			name: "RocketChat token field",
			expected: &alertmanagerConfig{
				Route: &route{
					Receiver: "rocketchat",
				},
			...
			golden: "RocketChat_token_field.golden",
		},
		{
			name: "RocketChat token_file field",
			expected: &alertmanagerConfig{
				Route: &route{
					Receiver: "rocketchat",
				},
			...
			golden: "RocketChat_token_file_field.golden",
		},
		{
			name: "RocketChat token_id field",
			expected: &alertmanagerConfig{
				Route: &route{
					Receiver: "rocketchat",
				},
				Receivers: []*receiver{
					{
						...
						RocketChatConfigs: []*rocketChatConfig{
							{
								APIURL:  "http://example.com",
								TokenID: ptr.To("aaaa-bbbb-cccc-dddd"),
							},
						},
					},
				},
			...
			golden: "RocketChat_token_id_field.golden",
		},
		{
			name: "RocketChat token_id_file field",
			expected: &alertmanagerConfig{
				Route: &route{
					Receiver: "rocketchat",
				},
			...
			golden: "RocketChat_token_id_file_field.golden",
		},
	}
